...
const resources = [
    { name: 'Daily Devotional', href: '#' },
    { name: 'Sermon Archive', href: '#' },
    { name: 'Bible Reading Plan', href: '#' },
...
<template>
    <footer class="bg-gray-900 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Main footer content -->
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 py-12">
                <!-- Brand column -->
                <div class="space-y-4">
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed">
                        Nourishing souls with God's word since 2008. Join our global community in faith, fellowship, and spiritual growth.
                    </p>
                    ...
                    <div class="pt-4">
                        ...
                        <form @submit.prevent class="space-y-2">
                            <input
                                ...
                                class="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                            />
                            <button
                                type="submit"
                                class="w-full bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white py-2 px-4 rounded-lg font-medium transition-colors"
                            >
                                Subscribe
                            </button>
                        </form>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start">
                                ...
                                <span class="text-gray-400 text-sm">123 Faith Street,<br>City, State 12345</span>
                            </div>
                            <div class="flex items-center">
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="text-gray-400 text-sm">info@ministrydailybread.org</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="border-t border-gray-800 py-6">
                <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    <div class="text-gray-500 text-sm">
                        &copy; {{ currentYear }} Global Ministries Daily Bread Fellowship. All rights reserved.
                    </div>
